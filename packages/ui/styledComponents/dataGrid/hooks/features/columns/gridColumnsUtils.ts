...
} from "../../../colDef/gridDefaultColumnTypes";
import { GridApiCommon } from "../../../models/api/gridApiCommon";
import { GridApiCommunity } from "../../../models/api/gridApiCommunity";
import { GridColDef, GridStateColDef } from "../../../models/colDef/gridColDef";
import { GridColType } from "../../../models/colDef/gridColType";
...
export const computeColumnTypes = (
  customColumnTypes: GridColumnTypesRecord = {}
) => {
  ...
  Object.entries(customColumnTypes).forEach(([colType, colTypeDef]) => {
    if (mergedColumnTypes[colType]) {
      ...
      mergedColumnTypes[colType] = {
        ...mergedColumnTypes[
          colTypeDef.extendType || DEFAULT_GRID_COL_TYPE_KEY
        ],
        ...colTypeDef,
      };
    }
...
export const createColumnsState = ({
  ...
  if (keepOnlyColumnsToUpsert && !isInsideStateInitializer) {
    Object.keys(columnsStateWithoutColumnVisibilityModel.lookup).forEach(
      (field) => {
  ...
  const columnsLookupBeforePreProcessing = {
    ...columnsStateWithoutColumnVisibilityModel.lookup,
  };

  const columnsStateWithPreProcessing: Omit<
    GridColumnsRawState,
