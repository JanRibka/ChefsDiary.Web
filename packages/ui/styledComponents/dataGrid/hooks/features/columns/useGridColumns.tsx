...
import { GridPreferencePanelsValue } from "../preferencePanel/gridPreferencePanelsValue";
import {
...
export const columnsStateInitializer: GridStateInitializer<
  Pick<
    ...
    "columnVisibilityModel" | "initialState" | "columnTypes" | "columns"
  >
> = (state, props, apiRef) => {
...
export function useGridColumns(
  ...
  >(
    (params, context) => {
      const columnVisibilityModelToImport = apiRef.current.unstable_caches
        .columns.isUsingColumnVisibilityModel
