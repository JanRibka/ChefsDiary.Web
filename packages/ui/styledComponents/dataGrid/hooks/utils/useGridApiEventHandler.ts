...
import { GridEventsStr } from "../../models/events/gridEvents";
import {
  CleanupTracking,
  UnregisterToken,
...
export function createUseGridApiEventHandler(
  ...
  >(
    ...
    const handlerRef = useRef<GridEventListener<E> | undefined>();
    handlerRef.current = handler;
    const cleanupTokenRef = useRef<UnregisterToken | null>(null);
...
export const useGridApiEventHandler = createUseGridApiEventHandler(
  registryContainer!
);
