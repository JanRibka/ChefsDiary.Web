...
export const inputLabelBaseVariants = tv({
  base: "absolute text-sm duration-300 transform scale-75 origin-[0] z-10 peer-placeholder-shown:scale-100 peer-focus:scale-75",
  variants: {
    error: {
      true: "text-error",
      false: noErrorStyle,
